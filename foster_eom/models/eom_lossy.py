...
class LossyCapacitorEOM(EOMModel):
    """Lossy capacitor EOM model with lead parasitics (spec §7.2).

    Z = Rs + j * omega * Ls + 1 / (G0 + j * omega * C0)
    """
    ...
    def __init__(
        ...
        """Initialize the lossy capacitor EOM model.
