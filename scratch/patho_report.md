...
Generated: 2026-08-19T22:53:50Z  
...
| ---- | -: | -: | ------: | --------------: | ------: | ----------: | ------------------: | ----------: | --------------: | ------- |
| PATHOLOGICAL_1201_GRID | 12 | 1236 | 234.58 s | 21.85 s | 10.74x | 600500 | 24020+24020=48040 | 0 | 0 | EQUIVALENT |
...
unmodified example grid: 1201 points / 1198 off-target hard rows, top-K=1, 1 domain, DE budget reduced (shared by both modes). `local_max_iterations` capped at **20**, identically for both modes. DE (shared, run once): 9.8 s. Basin pairs: 1.
...
| --- | --- | --: | --: | --: | --: | --: | --: | --: | --: | --: | --: | --: | --: |
| 43c25d79ed1bcb0e53a661278711916baac9afb0b8ac57ae67346cd5d9813317#0 | FD | 234.581 | 20 | 260 | 20 | 260 | 0 | 600500 | 0 | 0 | 0 | 0 | 0 |
| 43c25d79ed1bcb0e53a661278711916baac9afb0b8ac57ae67346cd5d9813317#0 | AN | 21.848 | 20 | 20 | 20 | 20 | 20 | 24020 | 24020 | 720 | 23960 | 20 | 21 |

### Scientific equivalence

| Basin | feasible FD/AN | v_max FD/AN | J FD/AN | endpoint | Δ\|Γ\| | ΔZin rel | ΔV_EOM rel | ‖Δu‖∞ | ΔL rel | ΔC rel | Δf_p rel | Verdict |
| --- | --- | --- | --- | --- | --: | --: | --: | --: | --: | --: | --: | --- |
| 43c25d79ed1b#0 | False/False | 0.2435/0.2435 | 13.781587/13.781587 | same | 0 | 0 | 0 | 0 | 0 | 0 | 0 | EQUIVALENT |
...
Peak RSS during polish: FD 3650 MB, analytical 415 MB.
...
| Category | seconds | % |
| --- | --: | --: |
| Y_p derivative stamps | 2.664 | 7.8% |
| MNA assembly | 1.880 | 5.5% |
| adjoint sensitivities | 1.601 | 4.7% |
| LU factor / nominal solve | 1.076 | 3.2% |
| conditioning check | 0.411 | 1.2% |
| nominal frequency sweep (evaluate) | 0.125 | 0.4% |
| optimizer overhead (scipy) | 0.065 | 0.2% |
| observables + constraint Jacobian | 0.056 | 0.2% |
| direct sensitivities | 0.002 | 0.0% |
| constraint / objective layout evaluate | 0.000 | 0.0% |
| other / interpreter overhead | 26.252 | 76.9% |
