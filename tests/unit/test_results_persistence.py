...
def test_save_load_optimization_result(tmp_path: Path):
    ...
    diag = SeedGenerationDiagnostics(
        n_orientation_attempts=1,
        n_sign_patterns=1,
        n_topologies=1,
        n_pole_layouts_branch1=1,
        n_pole_layouts_branch2=1,
        n_pole_layout_pairs=1,
        n_solver_attempts=1,
        n_mna_attempts=1,
        rejection_counts={},
    ...
    de_diag = DEDiagnostics(
        ...
        unique_x_evaluations=500,
        cache_hits=0,
        target_frequency_point_solves=500,
        coarse_frequency_point_solves=500,
        total_frequency_point_solves=1000,
